                            ...
                            <div class="card-body">
                                ...
                                <div class="info-container">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-75">
                                            <span class="fw-bolder me-25">ID Pengguna:</span>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="info-container">
                                                <form action="<?= base_url('user/update-password') ?>" class="form-horizontal" method="post">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group" style="margin-bottom: 10px">
                                                                <label class="form-label" for="password">Password</label>
                                                                <input type="hidden" name="id" value="<?= $user['ID_USER'] ?>">
                                                                <input class="form-control" name="password" id="password" type="password" placeholder="Type password here" />
                                                                <!-- <?php echo form_error('password', '<div class="error">', '</div>')?> -->
                                                            </div>
                                                        </div>
                                                        <!-- <div class="col-lg-12">
                                                            <div class="form-group" style="margin-bottom: 10px">
                                                                <label class="form-label" for="passconf">Password Confirmation</label>
                                                                <input class="form-control" name="passconf" id="passconf" type="password" placeholder="Type password confirmation here" />
