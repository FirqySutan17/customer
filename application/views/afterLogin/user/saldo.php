                        ...
                        <div class="row">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr style="border-style: hidden;">
                                                            ...
                                                            <td>:</td>
                                                            <td><?= number_format($saldo->REMAIN_MONTH) ?></td>
                                                        </tr>
                                                        <tr style="border-style: hidden;">
                                                            <td>Nilai barang yang dikirim per tanggal <?= date("d M Y", strtotime($saldo->NEXT_MONTH)) ?></td>
                                                            <td>:</td>
                                                            <td><?= number_format($saldo->DOC_SALES) ?></td>
                                                        </tr>
                                                        <tr style="border-style: hidden;">
                                                            <td>Pembayaran yang sudah kami terima per tanggal <?= date("d M Y", strtotime($saldo->NEXT_MONTH)) ?></td>
                                                            <td>:</td>
                                                            <td><?= number_format($saldo->CASH_IN_AMT) ?></td>
                                                        </tr>
                                                        <tr style="border-style: solid;">
                                                            <td>Potongan CN/TRansportasi/Kompensasi per tanggal <?= date("d M Y", strtotime($saldo->NEXT_MONTH)) ?></td>
                                                            <td>:</td>
                                                            <td>0</td>
                                                        </tr>
                                                        <tr >
                                                            <td>Total nilai barang yang harus dibayar (Saldo Akhir) per tanggal <?= date("d M Y", strtotime($saldo->NEXT_MONTH)) ?></td>
                                                            <td>:</td>
                                                            <td><?= number_format($saldo->REMAIN_NEXT_MONTH) ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <?php if (empty($check_saldo)): ?>
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="fw-bolder border-bottom pb-50 mb-1">Form Persetujuan</h4>
                                            <div class="info-container">
                                                <form action="<?= base_url('saldo') ?>" class="form-horizontal" method="post">
                                                    <input type="hidden" name="BG_REMAIN" value="<?= $saldo->REMAIN_MONTH ?>">
                                                    <input type="hidden" name="SALES_AMT" value="<?= $saldo->DOC_SALES ?>">
                                                    <input type="hidden" name="CASH_IN" value="<?= $saldo->CASH_IN_AMT ?>">
                                                    <input type="hidden" name="CN_AMOUNT" value="0">
                                                    <input type="hidden" name="ED_REMAIN" value="<?= $saldo->REMAIN_NEXT_MONTH ?>">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <div class="form-check form-check-inline">
                                                                  <input class="form-check-input" type="radio" name="persetujuan" id="setuju" value="Y" required>
                                                                  <label class="form-check-label" for="setuju">Setuju</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                  <input class="form-check-input" type="radio" name="persetujuan" id="tidak_setuju" value="N" required>
                                                                  <label class="form-check-label" for="tidak_setuju">TIdak Setuju</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group mt-2">
                                                                <label class="form-label" for="REMAKRS">Keterangan</label>
                                                                <textarea class="form-control" name="REMAKRS"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="form-group mt-2">
