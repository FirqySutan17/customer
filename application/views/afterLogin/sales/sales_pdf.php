	...
	<table width="100%">
		<tr>
			...
			<td width="30%" align="center">
				<span style="font-size: 18px;"><strong>SALES</strong></span>
					...
					<tr>
						<td style="border: 1px black solid" colspan="2">
							<p style="padding-left: 5px; font-size: 12px;">
								Kepada Yth :
								<br>
								<?= $invoice_data[0]->FULL_NAME ?>
								<br><br>
								<?= $invoice_data[0]->ADDRESS1 ?>
								<br>
								<?= $invoice_data[0]->ADDRESS2 ?>
							</p>
						</td>
					</tr>
					<tr>
	...
	<table width="100%" style="border-collapse:collapse;">
		...
		<tfoot>
			...
			<tr>
				...
				<td colspan="3" style="border: 1px solid black; padding: 2px; font-size: 12px">PPN 11%</td>
