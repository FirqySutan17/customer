...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url();?>assets/vuexy/app-assets/css/pages/page-faq.css">
    <!-- END: Page CSS-->
</head>
                    ...
                    <div class="row" id="coba">
                        <div class="col-lg-3 col-md-4 col-sm-12">
                            <div class="faq-navigation d-flex justify-content-between flex-column mb-2 mb-md-0">
                                ...
                                <!-- FAQ image -->
                                <img src="<?= base_url();?>assets/vuexy/app-assets/images/illustration/faq.svg" class="img-fluid d-none d-md-block" alt="demand img" />
                            </div>
                        </div>
